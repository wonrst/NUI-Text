...
namespace NUIText
{
    class Program : NUIApplication
    {
        ...
        public void GenerateUI(Size windowSize)
        {
            ...
            string[] texts = { "LIFE Picture Collection", "The Metropolitan Museum of Art", "National Gallery in Prague", "Tokyo National Museum", "Victoria and Albert Museum" };
            string[] descs = { "322 Pieces", "14 Pieces", "2 Pieces", "15 Pieces", "22 Pieces"};
