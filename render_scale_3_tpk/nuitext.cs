...
namespace NUIText
{
    class Program : NUIApplication
    {
        ...
        public void GenerateUI(Size windowSize)
        {
            ...
            menuView.Add(menu);
            {
                ...
                wrap.TouchEvent += (s, e) =>
                {
                    ...
                    SetSize(HORIZONTAL, WRAP_CONTENT, desc);
                    return true;
                };
                ...
                {
                    if (e == null || e.Touch.GetState(0) != PointStateType.Up) return true;
                    SetSize(HORIZONTAL, MATCH_PARENT, desc);
                    return true;
                };
            ...
            menuView.Add(menuv);
            {
                ...
                {
                    if (e == null || e.Touch.GetState(0) != PointStateType.Up) return true;
                    SetSize(VERTICAL, WRAP_CONTENT, desc);
                    return true;
                };
                ...
                {
                    if (e == null || e.Touch.GetState(0) != PointStateType.Up) return true;
                    SetSize(VERTICAL, MATCH_PARENT, desc);
                    return true;
                };
            ...
            menuView.Add(menuvv);
            {
                ...
                {
                    if (e == null || e.Touch.GetState(0) != PointStateType.Up) return true;
                    ELLIPSIS_MODE = EllipsisMode.Truncate;
                    return true;
                };
                ...
                {
                    if (e == null || e.Touch.GetState(0) != PointStateType.Up) return true;
                    ELLIPSIS_MODE = EllipsisMode.AutoScroll;
                    return true;
                };
            ...
            label.FocusGained += (s, e) =>
            {
                ...
                pixelSnap?.Clear();
                pixelSnap = new Animation(300);
                pixelSnap.AnimateTo(label, "pixelSnapFactor", 1.0f);
                pixelSnap.Play();

                scaleAnimation = new Animation(250);
            ...
            label.FocusLost += (s, e) =>
            {
                ...
                pixelSnap?.Clear();
                pixelSnap = new Animation(300);
                pixelSnap.AnimateTo(label, "pixelSnapFactor", 0.0f);
                pixelSnap.Play();
        ...
        public void SetRenderScale(float scale, TextLabel desc)
        {
        ...
        public void SetFontSize(float pixelSize, TextLabel desc)
        {
            FONT_SIZE = pixelSize;
            foreach (var label in labels)
            {
        ...
        public void SetSize(bool horizontal, int size, TextLabel desc)
        {
            foreach (var label in labels)
            {
                if (horizontal)
