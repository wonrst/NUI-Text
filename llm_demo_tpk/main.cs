...
namespace NUIText
{
    class Program : NUIApplication
    {
        ...
        public void GenerateUI(Size windowSize)
        {
            ...
            string backgroundUrl = "/images/back.jpg";
            ...
            streamSim = new LLMStreamSimulator(intervalMs: 3, chunkSize: 1);
        ...
        void StartStreamingPrev()
        {
            ...
            markdownRenderer.StartStreaming();
            streamSim.Start(sample, (chunk, idx) =>
            {
                sb.Append(chunk);
                markdownRenderer.Render(sb.ToString());
